...
namespace APIPortalLibrary.Services.Subscriptions
{
    ...
    {
        Task<ApiResponse<AllSubscriptions>> AllSubscriptions(string accessToken, string tokenType, string applicationId, int offset = 0, int limit = 0, string groupId="");//Get all subscriptions
        ...
        Task<ApiResponse<Subscription>> AddSubscription(string accessToken, string tokenType, string throttlingPolicy, string apiId, string applicationId);//Add subscription
