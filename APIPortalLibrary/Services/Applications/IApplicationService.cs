...
namespace APIPortalLibrary.Services.Applications
{
    public interface IApplicationService
    {
        ...
        Task<ApiResponse<Key>> ApplicationKeyDetailsOfGivenType(string accessToken, string tokenType, string applicationId, string keyMappingId, string groupId = "");//Get application details of a given type
